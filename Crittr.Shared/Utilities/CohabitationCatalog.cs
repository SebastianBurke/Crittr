...
public static class CohabitationCatalog
{
        ...
        new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Giant Day Gecko"]          = new() { SocialNeeds = SocialStructure.SoloOnly,  IsTerritorial = true,  IsPredatory = false, CohabNote = "Strictly one per enclosure; males fight to the death" },
        ["Tokay Gecko"]              = new() { SocialNeeds = SocialStructure.SoloOnly,  IsTerritorial = true,  IsPredatory = false, CohabNote = "Males fight; highly territorial — one per enclosure" },
        ...
        ["King Snake"]               = new() { SocialNeeds = SocialStructure.SoloOnly,  IsTerritorial = false, IsPredatory = true,  CohabNote = "Ophiophagous — will eat other snakes" },
